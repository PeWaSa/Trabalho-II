...
public class Produto {
    ...
    private boolean vencendoEm;

    public Produto(int id, String nome, String descricao, double preco, int quantidadeEstoqueMinimo, boolean estoqueBaixo, boolean vencendoEm) {
        this.id = id;
        this.nome = nome;
    ...
    public boolean isVencendoEm() {
        return vencendoEm;
    }

    public void setVencendoEm(boolean vencendoEm) {
        this.vencendoEm = vencendoEm;
    }
